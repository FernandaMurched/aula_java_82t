...
Scanner leia = new Scanner(System.in);
		...
		// Vetor de números inteiros inicializado com valores fixos //
		int vetorInteiros[] = {10, 15, 35, 70, 140, 280, 25, 84};
		...
		// Variável float para armazenar a soma dos elementos do vetor real //	
		float soma = 0;
		
		// Laço for tradicional para inserir dados do vetorReal //		
		...
		// For each - arrays uni e bidimencional (apenas para imprimir dados e não para acessar índices) //		
		...
		for(var valor : vetorReal) {
			...
			soma += valor; //só para pegar o valor //
		}
		
		// Exibindo resultado da soma //
			System.out.println("Resultado da soma: " + soma);
		
		// Ordenando vetorReal em ordem crescente //			
		...
		// Ordenados vetorReal em ordem decrescente //		
